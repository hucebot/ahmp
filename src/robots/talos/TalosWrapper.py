...
class Talos:
    def __init__(self):
        ...
        # ]
        self.left_foot_line_frames = ["left_lp", "left_lm"]
        self.right_foot_line_frames = ["right_lp", "right_lm"]

        self.left_foot_point_frames = ["left_point"]
        self.right_foot_point_frames = ["right_point"]
