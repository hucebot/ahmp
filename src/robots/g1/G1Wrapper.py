...
class G1:
    def __init__(self):
        ...
        self.left_foot_line_frames = ["left_foot_line_contact_upper", "left_foot_line_contact_lower"]
        self.right_foot_line_frames = ["right_foot_line_contact_upper", "right_foot_line_contact_lower"]

        self.left_foot_point_frames = ["left_foot_point_contact"]
        self.right_foot_point_frames = ["right_foot_point_contact"]
