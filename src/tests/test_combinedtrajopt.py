...
from nltrajopt.trajectory_optimization import *
        ...
        for contact_phase_fnames in contact_frames:
            ...
            stage_node.constraints_list.extend(
                [
                    ...
                    # VaultContactConstraints(0.7, 0.2, 0.5),
                    # ChimneyFrictionConstraints(y=0.3, mu=0.9),
                    # ChimneyContactConstraints(y=0.3),
                    # StairsContactConstraints(0.3, 0.3, 0.3),
                    HandrailsContactConstraints(0.3, 0.3, 0.3),
                ]
            )
            ...
            stage_node.costs_list.append(DeltaForce(np.array([0, 0, 0]), np.eye(3)))
